...
namespace APITemplate
{
    public partial class ApiIntegrationClient
    {
        ...
        private static readonly global::APITemplate.AutoSDKServer[] s_CreatePdfFromMarkdownServers = new global::APITemplate.AutoSDKServer[]
        ...
        private static readonly global::APITemplate.EndPointSecurityRequirement s_CreatePdfFromMarkdownSecurityRequirement0 =
        ...
        private static readonly global::APITemplate.EndPointSecurityRequirement[] s_CreatePdfFromMarkdownSecurityRequirements =
            new global::APITemplate.EndPointSecurityRequirement[]
            {                s_CreatePdfFromMarkdownSecurityRequirement0,
            };
        partial void PrepareCreatePdfFromMarkdownArguments(
        ...
        partial void PrepareCreatePdfFromMarkdownRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::APITemplate.CreatePdfFromMarkdownRequest request);
        partial void ProcessCreatePdfFromMarkdownResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePdfFromMarkdownResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::APITemplate.ResponseSuccessPDFFile> CreatePdfFromMarkdownAsync(
        ...
        {
            var __response = await CreatePdfFromMarkdownAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::APITemplate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::APITemplate.AutoSDKHttpResponse<global::APITemplate.ResponseSuccessPDFFile>> CreatePdfFromMarkdownAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePdfFromMarkdownArguments(
            ...
            var __authorizations = global::APITemplate.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePdfFromMarkdownSecurityRequirements,
                operationName: "CreatePdfFromMarkdownAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::APITemplate.PathBuilder(
                                path: "/v2/create-pdf-from-markdown",
                                baseUri: ResolveBaseUri(
                                servers: s_CreatePdfFromMarkdownServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePdfFromMarkdownRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::APITemplate.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::APITemplate.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreatePdfFromMarkdown",
                                methodName: "CreatePdfFromMarkdownAsync",
                                pathTemplate: "\"/v2/create-pdf-from-markdown\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePdfFromMarkdownResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::APITemplate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePdfFromMarkdownResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::APITemplate.ResponseSuccessPDFFile> CreatePdfFromMarkdownAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::APITemplate.CreatePdfFromMarkdownRequest
            {
                Body = body,
                Data = data,
                Css = css,
            ...
            return await CreatePdfFromMarkdownAsync(
                exportType: exportType,
                expiration: expiration,
                outputFormat: outputFormat,
                filename: filename,
