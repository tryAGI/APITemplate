...
namespace APITemplate
{
    public partial class ApiIntegrationClient
    {
        ...
        private static readonly global::APITemplate.AutoSDKServer[] s_AccountInformationServers = new global::APITemplate.AutoSDKServer[]
        ...
        private static readonly global::APITemplate.EndPointSecurityRequirement s_AccountInformationSecurityRequirement0 =
        ...
        private static readonly global::APITemplate.EndPointSecurityRequirement[] s_AccountInformationSecurityRequirements =
            new global::APITemplate.EndPointSecurityRequirement[]
            {                s_AccountInformationSecurityRequirement0,
            };
        partial void PrepareAccountInformationArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareAccountInformationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessAccountInformationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAccountInformationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::APITemplate.ResponseSuccessAccountInformation> AccountInformationAsync(
            global::APITemplate.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AccountInformationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::APITemplate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::APITemplate.AutoSDKHttpResponse<global::APITemplate.ResponseSuccessAccountInformation>> AccountInformationAsResponseAsync(
            global::APITemplate.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAccountInformationArguments(
                httpClient: HttpClient);


            var __authorizations = global::APITemplate.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_AccountInformationSecurityRequirements,
                operationName: "AccountInformationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::APITemplate.PathBuilder(
                                ...
                                servers: s_AccountInformationServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAccountInformationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::APITemplate.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::APITemplate.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AccountInformationAsync",
                                pathTemplate: "\"/v2/account-information\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAccountInformationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::APITemplate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAccountInformationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::APITemplate.ResponseSuccessAccountInformation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::APITemplate.AutoSDKHttpResponse<global::APITemplate.ResponseSuccessAccountInformation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::APITemplate.ResponseSuccessAccountInformation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
