                    ...
                    await global::APITemplate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::APITemplate.ResponseSuccessSingleFile.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::APITemplate.ResponseSuccessSingleFile.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
