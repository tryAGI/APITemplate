...
namespace APITemplate
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::APITemplate.ResponseSuccessStatus?), TypeInfoPropertyName = "NullableResponseSuccessStatus2")]
    ...
    internal sealed partial class TemplateManagementSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class TemplateManagementSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static TemplateManagementSourceGenerationContext Default { get; } = new(DefaultOptions);

        private TemplateManagementSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        {
            options.Converters.Add(new global::APITemplate.JsonConverters.UnixTimestampJsonConverter());
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::APITemplate.ResponseSuccessStatus)
            ...
            {
                if (typeToConvert == typeof(global::APITemplate.ResponseSuccessStatus))
                {
                    return new global::APITemplate.JsonConverters.ResponseSuccessStatusJsonConverter();
                }

                if (typeToConvert == typeof(global::APITemplate.ResponseSuccessStatus?))
                {
                    return new global::APITemplate.JsonConverters.ResponseSuccessStatusNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new TemplateManagementSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
