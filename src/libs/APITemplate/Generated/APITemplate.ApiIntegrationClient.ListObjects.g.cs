                    ...
                    await global::APITemplate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::APITemplate.ResponseSuccessListObjects.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::APITemplate.ResponseSuccessListObjects.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
