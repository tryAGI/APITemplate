...
internal static class CliRuntime
{
    ...
    public static async Task<global::APITemplate.APITemplateClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::APITemplate.ApiException exception)
    {
        var builder = new StringBuilder();
