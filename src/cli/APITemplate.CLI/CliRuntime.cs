...
namespace APITemplate.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "APITemplate.CLI";
    private const string UserSecretApiKeyName = "APITEMPLATE_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"APITEMPLATE_API_KEY"];
    private const string CredentialFileDirectoryName = ".apitemplate";

    public static async global::System.Threading.Tasks.Task<global::APITemplate.APITemplateClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::APITemplate.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::APITemplate.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::APITemplate.APITemplateClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::APITemplate.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::APITemplate.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::APITemplate.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::APITemplate.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("APITEMPLATE_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::APITemplate.ApiException exception)
    {
        var builder = new StringBuilder();
