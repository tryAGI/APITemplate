...
internal static partial class ApiIntegrationCreatePdfFromHtmlCommandApiCommand
{
...
");
                        ...
                        command.Options.Add(Data);                        command.Options.Add(SettingsOptions.PaperSize);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::APITemplate.CreatePdfFromHtmlRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var data = CliRuntime.WasSpecified(parseResult, Data) ? parseResult.GetValue(Data) : __requestBase is not null ? __requestBase.Data : default;

                        var __settingsBase = __requestBase?.Settings;                        var settingsPaperSize = CliRuntime.WasSpecified(parseResult, SettingsOptions.PaperSize) ? parseResult.GetValue(SettingsOptions.PaperSize) : __settingsBase is not null ? __settingsBase.PaperSize : default;
                        var settingsCustomWidth = CliRuntime.WasSpecified(parseResult, SettingsOptions.CustomWidth) ? parseResult.GetValue(SettingsOptions.CustomWidth) : __settingsBase is not null ? __settingsBase.CustomWidth : default;
                        var settingsCustomHeight = CliRuntime.WasSpecified(parseResult, SettingsOptions.CustomHeight) ? parseResult.GetValue(SettingsOptions.CustomHeight) : __settingsBase is not null ? __settingsBase.CustomHeight : default;
                        var settingsOrientation = CliRuntime.WasSpecified(parseResult, SettingsOptions.Orientation) ? parseResult.GetValue(SettingsOptions.Orientation) : __settingsBase is not null ? __settingsBase.Orientation : default;
                        var settingsHeaderFontSize = CliRuntime.WasSpecified(parseResult, SettingsOptions.HeaderFontSize) ? parseResult.GetValue(SettingsOptions.HeaderFontSize) : __settingsBase is not null ? __settingsBase.HeaderFontSize : default;
                        var settingsMarginTop = CliRuntime.WasSpecified(parseResult, SettingsOptions.MarginTop) ? parseResult.GetValue(SettingsOptions.MarginTop) : __settingsBase is not null ? __settingsBase.MarginTop : default;
                        var settingsMarginRight = CliRuntime.WasSpecified(parseResult, SettingsOptions.MarginRight) ? parseResult.GetValue(SettingsOptions.MarginRight) : __settingsBase is not null ? __settingsBase.MarginRight : default;
                        var settingsMarginBottom = CliRuntime.WasSpecified(parseResult, SettingsOptions.MarginBottom) ? parseResult.GetValue(SettingsOptions.MarginBottom) : __settingsBase is not null ? __settingsBase.MarginBottom : default;
                        var settingsMarginLeft = CliRuntime.WasSpecified(parseResult, SettingsOptions.MarginLeft) ? parseResult.GetValue(SettingsOptions.MarginLeft) : __settingsBase is not null ? __settingsBase.MarginLeft : default;
                        var settingsPrintBackground = CliRuntime.WasSpecified(parseResult, SettingsOptions.PrintBackground) ? parseResult.GetValue(SettingsOptions.PrintBackground) : __settingsBase is not null ? __settingsBase.PrintBackground : default;
                        var settingsDisplayHeaderFooter = CliRuntime.WasSpecified(parseResult, SettingsOptions.DisplayHeaderFooter) ? parseResult.GetValue(SettingsOptions.DisplayHeaderFooter) : __settingsBase is not null ? __settingsBase.DisplayHeaderFooter : default;
                        var settingsCustomHeader = CliRuntime.WasSpecified(parseResult, SettingsOptions.CustomHeader) ? parseResult.GetValue(SettingsOptions.CustomHeader) : __settingsBase is not null ? __settingsBase.CustomHeader : default;
                        var settingsCustomFooter = CliRuntime.WasSpecified(parseResult, SettingsOptions.CustomFooter) ? parseResult.GetValue(SettingsOptions.CustomFooter) : __settingsBase is not null ? __settingsBase.CustomFooter : default;
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ApiIntegration.CreatePdfFromHtmlAsync(
