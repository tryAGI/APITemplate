...
internal static partial class ApiIntegrationCreatePdfFromUrlCommandApiCommand
{
...
");
                        ...
                        command.Options.Add(Url);                        command.Options.Add(SettingsOptions.PaperSize);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::APITemplate.CreatePdfFromUrlRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ApiIntegration.CreatePdfFromUrlAsync(
